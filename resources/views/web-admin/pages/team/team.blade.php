...
@section('content')
                        ...
                        @foreach ($data as $key => $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @include('web-admin.pages.team.modal.update')
                                    ...
                                    @include('web-admin.pages.team.modal.update-photo')
                                    ...
                                    @include('web-admin.pages.team.modal.delete')
    ...
    @include('web-admin.pages.team.modal.create')
@endsection
