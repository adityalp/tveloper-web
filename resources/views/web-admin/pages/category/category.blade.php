...
@section('content')
                        ...
                        @foreach ($data as $key => $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @include('web-admin.pages.category.modal.update')
                                    ...
                                    @include('web-admin.pages.category.modal.delete')
    ...
    @include('web-admin.pages.category.modal.create')
@endsection
