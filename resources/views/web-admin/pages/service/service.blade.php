...
@section('content')
                        ...
                        @endphp
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @include('web-admin.pages.service.modal.update')
                                    ...
                                    @include('web-admin.pages.service.modal.update-photo')
                                    ...
                                    @include('web-admin.pages.service.modal.delete')
    ...
    @include('web-admin.pages.service.modal.create')
@endsection
