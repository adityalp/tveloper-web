...
@section('content')
                        ...
                        @endphp
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @include('web-admin.pages.contact.modal.update')
                                    ...
                                    @include('web-admin.pages.contact.modal.delete')
    ...
    @include('web-admin.pages.contact.modal.create')
@endsection
